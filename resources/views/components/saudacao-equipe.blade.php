            ...
            @if ($equipes->user_id == auth()->user()->id)
                <div class="dropdown mx-1">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item py-2" href="{{route('equipes.edit')}}"><i class="bi-people-fill"></i> Equipe</a></li>
                        <li><a class="dropdown-item py-2" href="{{route('equipes.participantes')}}"><i class="bi-person-square"></i> Participantes</a></li>
                    </ul>
                </div>
            @endif
        </div>
